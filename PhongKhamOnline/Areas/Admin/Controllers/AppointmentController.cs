...
namespace PhongKhamOnline.Controllers
{
    ...
    public class AppointmentController : Controller
    {
        ...
        public AppointmentController(UserManager<ApplicationUser> userManager, IDatLichKhamRepository datLichKhamRepository, IBacSiRepository bacSiRepository, IKhungThoiGianRepository khungThoiGianRepository)
        {
