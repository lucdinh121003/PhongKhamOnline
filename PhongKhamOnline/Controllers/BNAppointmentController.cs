...
{
    public class BNAppointmentController : Controller
    {
        ...
        public BNAppointmentController(UserManager<ApplicationUser> userManager, IDatLichKhamRepository datLichKhamRepository, IBacSiRepository bacSiRepository, IKhungThoiGianRepository khungThoiGianRepository)
        {
        ...
        public async Task<IActionResult> DatLich(Appointment appointment)
        {
            if (ModelState.IsValid!=null)
            {
                ...
                return RedirectToAction("Index", "BNAppointment");
            }
